...
<svg id="404-Dave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 250">
    ...
    <div class="button_cont" align="center"><a class="example_b" href="{{ route('index') }}" rel="nofollow noopener" style="text-decoration: none">back to home</a></div>
</body>
</html>
