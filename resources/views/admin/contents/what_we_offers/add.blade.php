    ...
    <div class="main-content bg-white border-left">
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <h2>Add Offers</h2>
                <br>
                <form action="{{ route('what_we_offers.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="home" class="container tab-pane active"><br>
                                ...
                                <textarea name="body_uz" id="techno_uz" cols="30" rows="7" class="ckeditor form-control {{ $errors->has('body_uz') ? ' is-invalid' : '' }}" placeholder="Qisqacha ta'rif">{{ old('body_uz') }}</textarea>
