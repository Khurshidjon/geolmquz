    ...
    <div class="main-content bg-white border-left">
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                ...
                <br>
                <form action="{{ route('certificats.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="home" class="container tab-pane active"><br>
                                ...
                                <input id="title_uz" type="text" class="form-control {{ $errors->has('title_uz') ? ' is-invalid' : '' }}" name="title_uz" placeholder="Sertifikat nomi" value="{{ old('title_uz') }}" autocomplete="off">
                                ...
                                <textarea name="body_uz" id="body_uz" cols="30" rows="7" class="ckeditor form-control {{ $errors->has('body_uz') ? ' is-invalid' : '' }}">{{ old('body_uz') }}</textarea>
                            ...
                            <div id="menu1" class="container tab-pane fade"><br>
                                ...
                                <input id="title_ru" type="text" class="form-control {{ $errors->has('title_ru') ? ' is-invalid' : '' }}" name="title_ru" placeholder="Наименование сертификата" value="{{ old('title_ru') }}" autocomplete="off">
                                ...
                                <textarea name="body_ru" id="body_ru" cols="30" rows="7" class="ckeditor form-control {{ $errors->has('body_ru') ? ' is-invalid' : '' }}">{{ old('body_ru') }}</textarea>
                            ...
                            <div id="menu2" class="container tab-pane fade"><br>
                                ...
                                <input id="title_en" type="text" class="form-control {{ $errors->has('title_en') ? ' is-invalid' : '' }}" name="title_en" placeholder="Certificat name" value="{{ old('title_en') }}" autocomplete="off">
                                ...
                                <textarea name="body_en" id="body_en" cols="30" rows="7" class="ckeditor form-control {{ $errors->has('body_en') ? ' is-invalid' : '' }}">{{ old('body_en') }}</textarea>
