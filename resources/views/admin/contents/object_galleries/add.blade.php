    ...
    <div class="main-content bg-white border-left">
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                ...
                <br>
                <form action="{{ route('object_galleries.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="object_id">Ob'ektga biriktirmoq</label>
                                <select name="object_id" id="object_id" class="form-control {{ $errors->has('object_id') ? ' is-invalid' : '' }}">
                                    ...
                                    @foreach($objects as $object)
                                        @if($lang=='uz')
                                            <option value="{{ $object->id }}">{{ $object->title_uz }}</option>
                                        @elseif($lang=='ru')
                                            <option value="{{ $object->id }}">{{ $object->title_ru }}</option>
                                        @elseif($lang=='en')
                                            <option value="{{ $object->id }}">{{ $object->title_en }}</option>
                                        @endif
                                    @endforeach
                                </select>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="home" class="container tab-pane active"><br>
                                ...
                                <input id="title_uz" type="text" class="form-control {{ $errors->has('title_uz') ? ' is-invalid' : '' }}" name="title_uz" placeholder="Rasm nomi" value="{{ old('title_uz') }}" autocomplete="off">
                            ...
                            <div id="menu1" class="container tab-pane fade"><br>
                                ...
                                <input id="title_ru" type="text" class="form-control {{ $errors->has('title_ru') ? ' is-invalid' : '' }}" name="title_ru" placeholder="Наименование фото" value="{{ old('title_ru') }}" autocomplete="off">
                            ...
                            <div id="menu2" class="container tab-pane fade"><br>
                                ...
                                <input id="title_en" type="text" class="form-control {{ $errors->has('title_en') ? ' is-invalid' : '' }}" name="title_en" placeholder="Photo name" value="{{ old('title_en') }}" autocomplete="off">
