                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div>
                                    ...
                                    <img src="{{ asset('storage') .'/'. $slider->slider_photo }}" class="changed_image" alt="">
                                </div>
                            </div>
                        </div>
                        <br>
                        <div class="tab-content">
                            ...
                            <div id="home" class="container tab-pane active"><br>
                                ...
                                <input id="title_uz" type="text" class="form-control {{ $errors->has('title_uz') ? ' is-invalid' : '' }}" name="title_uz" placeholder="Slider sarlavhasi" value="{{ old('title_uz', $slider->title_uz) }}" autocomplete="off">
                                ...
                                <textarea name="body_uz" id="body_uz" cols="30" rows="7" class="ckeditor form-control {{ $errors->has('body_uz') ? ' is-invalid' : '' }}" placeholder="Qisqacha ta'rif">{{ old('body_uz', $slider->body_uz) }}</textarea>
                            ...
                            <div id="menu1" class="container tab-pane fade"><br>
                                ...
                                <input id="title_ru" type="text" class="form-control {{ $errors->has('title_ru') ? ' is-invalid' : '' }}" name="title_ru" placeholder="Название слайдера" value="{{ old('title_ru', $slider->title_ru) }}" autocomplete="off">
                                ...
                                <textarea name="body_ru" id="body_ru" cols="30" rows="7" class="ckeditor form-control {{ $errors->has('body_ru') ? ' is-invalid' : '' }}" placeholder="Описание">{{ old('body_ru', $slider->body_ru) }}</textarea>
                            ...
                            <div id="menu2" class="container tab-pane fade"><br>
                                ...
                                <input id="title_en" type="text" class="form-control {{ $errors->has('title_en') ? ' is-invalid' : '' }}" name="title_en" placeholder="Slider titleZ" value="{{ old('title_en', $slider->title_en) }}" autocomplete="off">
                                ...
                                <textarea name="body_en" id="body_en" cols="30" rows="7" class="ckeditor form-control {{ $errors->has('body_en') ? ' is-invalid' : '' }}" placeholder="Description">{{ old('body_en', $slider->body_en) }}</textarea>
