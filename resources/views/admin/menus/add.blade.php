                    ...
                    <div class="form-group row">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="home" class="container tab-pane active"><br>
                                    {{--uz form--}}
                                        ...
                                        <input id="menu_uz" type="text" class="form-control {{ $errors->has('menu_uz') ? ' is-invalid' : '' }}" name="menu_uz" value="{{ old('menu_uz') }}" placeholder="Menu nomi">
                                        ...
                                        <textarea name="description_uz" id="description_uz" cols="30" rows="7" class="form-control {{ $errors->has('description_uz') ? ' is-invalid' : '' }}" placeholder="Qisqacha ta'rif">{{ old('description_uz') }}</textarea>
                                ...
                                <div id="menu1" class="container tab-pane fade"><br>
                                        ...
                                        <input id="menu_ru" type="text" class="form-control {{ $errors->has('menu_ru') ? ' is-invalid' : '' }}" name="menu_ru" value="{{ old('menu_ru') }}" placeholder="Название меню">
                                        ...
                                        <textarea name="description_ru" id="description_ru" cols="30" rows="7" class="form-control {{ $errors->has('description_ru') ? ' is-invalid' : '' }}" placeholder="Описание">{{ old('description_ru') }}</textarea>
                                ...
                                <div id="menu2" class="container tab-pane fade"><br>
                                        ...
                                        <input id="menu_en" type="text" class="form-control {{ $errors->has('menu_en') ? ' is-invalid' : '' }}" name="menu_en" value="{{ old('menu_en') }}" placeholder="Menu name">
                                        ...
                                        <textarea name="description_en" id="description_en" cols="30" rows="7" class="form-control {{ $errors->has('description_en') ? ' is-invalid' : '' }}" placeholder="Description">{{ old('description_en') }}</textarea>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="status" id="status" class="form-control {{ $errors->has('status') ? ' is-invalid' : '' }}">
                                ...
                                <option value="2">Active & Parent</option>
                            ...
                            <input id="menu_photo" type="file" class="form-control {{ $errors->has('menu_photo') ? ' is-invalid' : '' }}" name="menu_photo" accept="image/jpeg, image/jpg, image/png">
